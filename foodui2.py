        ...
        if operation == "Fetch Product":
            ...
            if not category.strip():
                ...
                params = {
                    ...
                    "fields": "code,product_name,brands,quantity,nutrition_grades,categories,ecoscore_grade,image_small_url,ingredients_text,allergens_tags,labels_tags,countries_tags,misc_tags"
                }
                if grade:
